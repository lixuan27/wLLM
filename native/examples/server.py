...
def parse_args():
    parser = argparse.ArgumentParser(description="wLLM inference server")
...
app = FastAPI(title="wLLM", version=wllm_native.__version__)
...
async def health():
    return {
        ...
        "version": wllm_native.__version__,
        "prompt": model.prompt,
    }
