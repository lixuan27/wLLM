...
- wLLM installed and verified per [`docs/INSTALL.md`](../../docs/INSTALL.md)
  (you should have `wllm_native/wllm_native_kernels*.so` in place and
  `python -c "import wllm_native; print(wllm_native.__version__)"` works)
...
```
============================================================
wLLM Thor — Pi0.5 LIBERO Spatial
============================================================
...
to `~/.wllm/calibration/`. Subsequent runs against the same
...
| Comparison | Cosine |
|-----------|--------|
| wLLM Torch vs Production | **0.9996** |
| wLLM JAX vs Production | **0.9999** |
| wLLM Torch vs JAX | **0.9998** |
...
|----------|--------|--------|--------|
| **wLLM Torch** | **36.5 ms** (27 Hz) | **44.0 ms** (23 Hz) | **54.8 ms** (18 Hz) |
| **wLLM JAX** (autotune=5) | **37.3 ms** (27 Hz) | **44.9 ms** (22 Hz) | **54.4 ms** (18 Hz) |
...
| Frontend | 1-view | 2-view | 3-view |
|----------|--------|--------|--------|
| **wLLM Torch** (autotune=5) | **37.6 ms** (27 Hz) | **45.8 ms** (22 Hz) | **56.7 ms** (18 Hz) |
| **wLLM JAX** (autotune=5) | **37.8 ms** (26 Hz) | **45.8 ms** (22 Hz) | **55.9 ms** (18 Hz) |
...
| Symptom | Likely fix |
|---|---|
| `No module named 'wllm_native_kernels'` | Build step skipped or non-editable install — see [`docs/INSTALL.md`](../../docs/INSTALL.md) §6 |
