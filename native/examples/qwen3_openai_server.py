#!/usr/bin/env python3
"""wLLM — Qwen3-8B-NVFP4 OpenAI-compatible HTTP server.

Provides /v1/chat/completions backed by the wLLM NVFP4 path on
...
class Qwen3Engine:
    ...
    def __init__(self, *, checkpoint: str, device: str, model_name: str,
        ...
        import torch
        from wllm.native.frontends.torch.qwen3_rtx import (
...
def build_app(engine: 'Qwen3Engine'):
    ...
    app = FastAPI(title='wLLM Qwen3-8B NVFP4 OpenAI-compatible server')
