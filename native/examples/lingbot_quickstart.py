...
Build first (one shared module — LingBot kernels live inside wllm_native_kernels):
...
printed FA4 status (``wllm_native.hardware.thor.fa4_backend.status()``).
"""
import argparse
import time
...
from wllm.native.executors.torch_weights import SafetensorsSource
from wllm.native.executors.weight_loader import WeightLoader
from wllm.native.frontends.torch._lingbot_thor_spec import build_spec
from wllm.native.models.lingbot.buffer_binder import bind_target_to_device
from wllm.native.models.lingbot.kernel_ops import clear_fp8_weight_cache
from wllm.native.models.lingbot.graph_runner import sample_actions_graph
from wllm.native.models.lingbot import calibration as calib
