// ================================================================
// wllm_native_omnivoice — standalone pybind module for OmniVoice-specific
// fused kernels (kept separate from wllm_native_kernels so they can be
...
PYBIND11_MODULE(wllm_native_omnivoice, m) {
    ...
    m.def("omnivoice_qk_norm_rope_bf16",
        [](uintptr_t dq, uintptr_t q_weight, uintptr_t k_weight,
           ...
           uintptr_t stream) {
            wllm_native::kernels::omnivoice_qk_norm_rope_bf16(
