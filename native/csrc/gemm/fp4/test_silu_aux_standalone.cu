...
int main() {
    ...
    int x_sfa_sz = wllm_native::fp4::sfa_size_bytes(M, K, /*is_sfb=*/false);
    CHECK(cudaMalloc(&d_X_sfa, x_sfa_sz));
    int rc = wllm_native::fp4::quantize_fp4_dynamic_sfa_fp16(
    ...
    int wu_sfb_sz = wllm_native::fp4::sfa_size_bytes(N, K, /*is_sfb=*/true);
    CHECK(cudaMalloc(&d_Wu_sfb, wu_sfb_sz));
    rc = wllm_native::fp4::quantize_fp4_dynamic_sfa_fp16(
    ...
    int d_sfa_sz = wllm_native::fp4::sfa_size_bytes(M, N, /*is_sfb=*/false);
    ...
    rc = wllm_native::fp4::cutlass_fp4_gemm_silu_aux_fp4(
        d_X_packed, d_X_sfa,
    ...
    for (int i = 0; i < warmup; ++i) {
      wllm_native::fp4::cutlass_fp4_gemm_silu_aux_fp4(
