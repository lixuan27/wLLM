// ============================================================================
// wLLM — SMEM-only EVT visitors + FusionOperation tags
...
//                        same SMEM buffer.
//
// Two FusionOperation tags (wLLM-specific):
...
namespace wllm::megakernel::fusion {
...
// ============================================================================
// FusionOperation tags (wLLM-specific).
//
...
struct FusionCallbacks<
    ...
    wllm::megakernel::fusion::LinCombEltActSmemAuxStore<
...
> : wllm::megakernel::fusion::Sm100LinCombEltActSmemAuxStoreTree<
    ...
    >
{
  using Impl = wllm::megakernel::fusion::Sm100LinCombEltActSmemAuxStoreTree<
      decltype(cute::take<0,2>(CtaTileShapeMNK{})),
      EpilogueTile, SmemLayoutAtom, CopyOpR2S,
      ActivationFn, ElementOutput, ElementCompute, ElementAux,
      ElementSource, ElementScalar, RoundStyle>;

  using Operation = wllm::megakernel::fusion::LinCombEltActSmemAuxStore<
      ActivationFn, ElementOutput, ElementCompute,
      ElementAux, ElementSource, ElementScalar, AlignmentAux, RoundStyle>;
...
struct FusionCallbacks<
    cutlass::epilogue::Sm90TmaWarpSpecialized<StagesC, StagesD, FragmentSize, ReuseSmemC, DelayTmaStore>,
    wllm::megakernel::fusion::LinCombDeEltActSmemAuxLoad<
        ActivationFn, ElementOutput, ElementCompute,
        ElementAux, ElementSource, ElementScalar, AlignmentAux, RoundStyle>,
    CtaTileShapeMNK, EpilogueTile,
    SmemLayoutAtom, CopyOpS2R
> : wllm::megakernel::fusion::Sm100LinCombDeEltActSmemAuxLoadTree<
        decltype(cute::take<0,2>(CtaTileShapeMNK{})),
        EpilogueTile,
        SmemLayoutAtom, CopyOpS2R,
        ActivationFn, ElementOutput, ElementCompute, ElementAux,
    ...
    >
{
  using Impl = wllm::megakernel::fusion::Sm100LinCombDeEltActSmemAuxLoadTree<
      decltype(cute::take<0,2>(CtaTileShapeMNK{})),
      EpilogueTile, SmemLayoutAtom, CopyOpS2R,
      ActivationFn, ElementOutput, ElementCompute, ElementAux,
      ElementSource, ElementScalar, RoundStyle>;

  using Operation = wllm::megakernel::fusion::LinCombDeEltActSmemAuxLoad<
      ActivationFn, ElementOutput, ElementCompute,
      ElementAux, ElementSource, ElementScalar, AlignmentAux, RoundStyle>;
