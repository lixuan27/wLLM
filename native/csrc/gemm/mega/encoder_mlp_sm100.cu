// ================================================================
// wLLM — Path C megakernel: encoder MLP fused (G7+GeGLU+G8)
...
// implemented yet. Built only behind -DWLLM_BUILD_SM100_ENCODER_MLP=ON
// so production wllm_native_kernels neither compiles nor exports it.
//
