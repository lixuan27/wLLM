// ============================================================================
//  wLLM — pybind module for vendored Flash-Attention 2.
//
//  Built as a SEPARATE .so from wllm_native_kernels.so to keep the main kernel
...
//  same pattern as wllm_native_fp4.so.
//
//  Python-side usage:
//
//      import wllm_native.wllm_native_kernels as fvk        # unchanged
//      import wllm_native.wllm_native_fa2     as fa2        # new, additive
...
PYBIND11_MODULE(wllm_native_fa2, m) {
    m.doc() = "wLLM — vendored Flash-Attention 2 forward (fp16 + bf16).";
