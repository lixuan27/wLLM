...
if BACKEND == "torch":
    from wllm.native.frontends.torch.pi05_thor import Pi05TorchFrontendThor as Frontend
    CKPT = "TORCH_CKPT"
    NUM_VIEWS = 2
elif BACKEND == "jax":
    from wllm.native.frontends.jax.pi05_thor import Pi05JaxFrontendThor as Frontend
    CKPT = "JAX_CKPT"
    NUM_VIEWS = 2
else:
