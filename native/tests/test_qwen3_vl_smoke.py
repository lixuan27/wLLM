...
def test_frontend_imports():
    ...
    m = importlib.import_module('wllm_native.frontends.torch.qwen3_vl_rtx')
...
def test_require_kernels_fails_fast_on_missing_symbols():
    ...
    from wllm.native.frontends.torch.qwen3_vl_rtx import _check_qwen3_vl_kernels
    ...
    assert 'WLLM_BUILD_QWEN3_VL' in str(ei.value)
...
def test_kernel_module_complete_when_built():
    ...
    try:
        ...
        pytest.skip('wllm_native_qwen3_vl_kernels not built')
    from wllm.native.frontends.torch.qwen3_vl_rtx import _check_qwen3_vl_kernels
