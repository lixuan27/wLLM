...
def test_torch_fused_qkv_with_norm_and_interleave():
    if not _torch_available():
        ...
        return
    import torch
    from wllm.native.core.thor_frontend_utils import interleave_qk as core_iqk
    from wllm.native.executors.torch_weights import (
...
def test_torch_quant_and_scale_publication():
    if not _torch_available():
        ...
        return
    import torch
    from wllm.native.core.thor_frontend_utils import quant_fp8
    from wllm.native.executors.torch_weights import (
...
def _jax_available():
    try:
        import jax  # noqa
        from wllm.native.core.cuda_buffer import CudaBuffer  # noqa
        return True
    except Exception:
        return False
...
def test_jax_orbax_dict_source_and_numpy_sinks():
    ...
    from wllm.native.executors.jax_weights import (
