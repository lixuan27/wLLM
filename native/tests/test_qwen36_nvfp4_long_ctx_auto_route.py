...
CKPT_NVFP4 = os.environ.get('WLLM_QWEN36_NVFP4_CKPT_DIR', '')
CKPT_MTP = os.environ.get('WLLM_QWEN36_MTP_CKPT_DIR', '')
...
pytestmark = pytest.mark.skipif(
    ...
    reason=(
        ...
        'WLLM_QWEN36_NVFP4_CKPT_DIR / WLLM_QWEN36_MTP_CKPT_DIR '
        'to override.'
    ),
)
...
def test_short_ctx_spec_path_unchanged():
    ...
    os.environ.setdefault('WLLM_QWEN36_MTP_CKPT_DIR', CKPT_MTP)
