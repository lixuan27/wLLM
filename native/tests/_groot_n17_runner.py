...
Each forward in ``wllm_native.models.groot_n17.pipeline_thor`` is validated
...
class CausalLlmAttnAdapter:
    ...
    Why: the wLLM ``attention_mha_fp16`` and ``attention_qkv_fp16``
...
class Fp8Calibrator:
    ...
    All FP8 tensors in the wLLM pipeline are E4M3 (range ±448) with
...
from wllm.native.models.groot_n17.calibration import build_vit_rope_tables  # noqa: F401
