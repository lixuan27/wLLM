...
from wllm.native.frontends.torch import _qwen36_rtx_dflash_forward as dff  # noqa: E402
from wllm.native.frontends.torch.qwen36_rtx import (  # noqa: E402
    Qwen36TorchFrontendRtx,
)
from wllm.native.frontends.torch.qwen36_thor import (  # noqa: E402
...
def test_thor_pertoken_default_on(monkeypatch):
    monkeypatch.delenv("WLLM_QWEN36_DFLASH_PERTOKEN", raising=False)
    monkeypatch.delenv("WLLM_QWEN36_DFLASH_WINDOW", raising=False)
...
def test_thor_pertoken_env_opt_out(monkeypatch):
    monkeypatch.setenv("WLLM_QWEN36_DFLASH_PERTOKEN", "0")
    fe = _thor_drafter_load(monkeypatch)
...
def test_thor_pertoken_window_env_override(monkeypatch):
    monkeypatch.delenv("WLLM_QWEN36_DFLASH_PERTOKEN", raising=False)
    monkeypatch.setenv("WLLM_QWEN36_DFLASH_WINDOW", "64")
    fe = _thor_drafter_load(monkeypatch)
