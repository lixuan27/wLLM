...
def test_qwen3_vl_rtx_bf16_frontend_imports():
    m = importlib.import_module('wllm_native.frontends.torch.qwen3_vl_rtx_bf16')
...
def test_require_kernels_raises_on_missing_core_symbol():
    ...
    with mock.patch.dict('sys.modules', {
        'wllm_native.wllm_kernels': _FakeFvk,
        'wllm_native.wllm_qwen3_vl_kernels': _FakeVlk,
    }):
...
def test_kernel_modules_complete_when_built():
    ...
    try:
        ...
        pytest.skip('wllm_native kernel modules not built')
    m = importlib.import_module('wllm_native.frontends.torch.qwen3_vl_rtx_bf16')
    ...
    assert not fvk_missing, f'wllm_native_kernels missing: {fvk_missing}'
    assert not vlk_missing, f'wllm_native_qwen3_vl_kernels missing: {vlk_missing}'
...
def test_bf16_weight_loader_exports_invariant_fn():
    ...
    m = importlib.import_module('wllm_native.frontends.torch._qwen3_vl_bf16_weights')
