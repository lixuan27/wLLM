...
def _make_synthetic_ie(qwen3, seed):
    ...
    from wllm.native.models.groot.pipeline_rtx import QWEN3_D
...
def test_qwen3_per_sample_n1_matches_legacy_impl():
    ...
    """
    from wllm.native.frontends.torch.groot_rtx import (
...
def test_qwen3_per_sample_shape_and_finiteness():
    ...
    from wllm.native.models.groot.pipeline_rtx import QWEN3_L
...
def test_qwen3_per_sample_empty_raises():
    ...
    from wllm.native.frontends.torch.groot_rtx import _calibrate_qwen3_per_sample
...
def test_dit_per_sample_empty_raises():
    ...
    from wllm.native.frontends.torch.groot_rtx import _calibrate_dit_per_sample
...
def test_calibrate_multi_frame_end_to_end():
    ...
    from wllm.native.models.groot.pipeline_rtx import DIT_L, QWEN3_L
