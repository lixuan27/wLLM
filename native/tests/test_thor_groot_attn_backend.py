...
def test_groot_spec_mha_kernels():
    ...
    from wllm.native.hardware.thor.attn_backend_groot import make_groot_attention_spec
...
def test_reject_extra_site():
    from wllm.native.hardware.thor.attn_backend_groot import ThorGrootAttnBackend
