...
def test_reject_extra_site():
    from wllm.native.hardware.thor.attn_backend import ThorFlashAttnBackend
...
def test_pi0_spec_decoder_extra():
    ...
    from wllm.native.hardware.thor.attn_backend import make_pi0_attention_spec
    spec = make_pi0_attention_spec(num_views=2, enc_seq_max=600, S_dec=11)
    ...
    from wllm.native.hardware.thor.attn_backend import make_pi05_attention_spec
