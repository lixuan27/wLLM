#!/usr/bin/env python3
"""wLLM Pi0-FAST precision test (autoregressive variant).
...
from wllm.native.frontends.PIPELINE_MODULE import PIPELINE_CLASS
...
def main():
    ...
    print("=" * 72)
    print("wLLM — Pi0-FAST Precision Test (autoregressive)")
    print("=" * 72)
