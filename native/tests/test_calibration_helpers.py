"""Unit tests for wllm_native.core.calibration.
...
from wllm.native.core.calibration import check_scale_ceiling, FP8_SCALE_RATIO_WARN
...
def test_check_scale_ceiling_warns_on_outlier(caplog):
    ...
    caplog.set_level(_log.WARNING, logger="wllm_native.core.calibration")
...
def test_stratified_sample_indices_n8_task8():
    from wllm.native.core.calibration import stratified_sample_indices
    df = _make_dummy_meta()
...
def test_stratified_sample_applies_load_fn():
    from wllm.native.core.calibration import stratified_sample
    df = _make_dummy_meta()
