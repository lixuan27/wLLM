# wLLM Jetson AGX Orin (SM87) Deployment Guide
...
`wllm_native/hardware/__init__.py` dispatches Orin to the RTX Pi0.5 pipeline:

```
("pi05", "torch", "rtx_sm87") → wllm_native.frontends.torch.pi05_rtx.Pi05TorchFrontendRtx
```
