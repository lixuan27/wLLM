...
>
> **Source**: [`wllm_native/executors/weight_loader.py`](../../wllm_native/executors/weight_loader.py) — protocols + runner. Concrete sources / sinks live in `executors/torch_weights.py` and `executors/jax_weights.py`.
...
```python
# wllm_native/frontends/torch/_pi05_thor_spec.py
...
The transforms shipped under `wllm_native/executors/torch_weights.py`:
...
Real fragment from `wllm_native/frontends/torch/_pi05_thor_spec.py`, simplified:
...
| What | File |
|---|---|
| Protocols + runner | [`executors/weight_loader.py`](../../wllm_native/executors/weight_loader.py) |
| Torch sources / transforms / sinks | [`executors/torch_weights.py`](../../wllm_native/executors/torch_weights.py) |
| JAX sources / transforms / sinks | [`executors/jax_weights.py`](../../wllm_native/executors/jax_weights.py) |
| Pi0.5 spec example | `wllm_native/frontends/torch/_pi05_thor_spec.py` |
| Pi0 spec example | `wllm_native/frontends/torch/_pi0_thor_spec.py` |
| GROOT spec example | `wllm_native/frontends/torch/_groot_thor_spec.py` |
| Pi0-FAST spec example | `wllm_native/frontends/torch/_pi0fast_thor_spec.py` |
