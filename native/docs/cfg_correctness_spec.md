...
This document is the **release contract** for wLLM's classifier-free
...
|---|---|---|
| **Reference** ($\mathcal{R}_\text{fp32}$) | `Pi05CFGReference` | `wllm_native/refs/pi05_cfg_reference.py` |
| Serial CFG (FP8) | `Pi05CFGPipeline` | `wllm_native/models/pi05/pipeline_rtx_cfg.py` |
| Batched CFG (FP8, B=2) | `Pi05CFGBatchedPipeline` | `wllm_native/models/pi05/pipeline_rtx_cfg_batched.py` |
...
wLLM's `decoder_action_buf` is the raw action-projection output
