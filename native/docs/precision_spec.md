...
```python
from wllm.native.core.precision_spec import PrecisionSpec, ModelPrecisionSpec
...
| `nvfp4` | `per_group` (size 16) | `symmetric` | Already partially shipped on Thor as separate module (`wllm_native_fp4`) |
