...
| Frontends | [`Pi05TorchFrontendRtx`](../wllm_native/frontends/torch/pi05_rtx.py) (safetensors) / [`Pi05JaxFrontendRtx`](../wllm_native/frontends/jax/pi05_rtx.py) (Orbax) | [`Pi05TorchFrontendThor`](../wllm_native/frontends/torch/pi05_thor.py) (safetensors) / [`Pi05JaxFrontendThor`](../wllm_native/frontends/jax/pi05_thor.py) (Orbax) |
...
(shared builder in [`wllm_native/core/rl/`](../wllm_native/core/rl/)),
...
```python
from wllm.native.frontends.torch.pi05_thor import Pi05TorchFrontendThor
...
- π\*0.6 paper — [arXiv:2511.14759](https://arxiv.org/abs/2511.14759),
  ...
  gradient.
- [`wllm_native/core/rl/`](../wllm_native/core/rl/) — framework-agnostic
...
- Pipeline classes:
  - RTX: [`pipeline_rtx_cfg.py`](../wllm_native/models/pi05/pipeline_rtx_cfg.py),
    [`pipeline_rtx_cfg_batched.py`](../wllm_native/models/pi05/pipeline_rtx_cfg_batched.py)
  - Thor: [`pipeline_thor_cfg.py`](../wllm_native/models/pi05/pipeline_thor_cfg.py),
    [`pipeline_thor_cfg_batched.py`](../wllm_native/models/pi05/pipeline_thor_cfg_batched.py)
