...
wLLM inference path for [Qwen3-8B-Instruct](https://huggingface.co/Qwen/Qwen3-8B-Instruct)
...
```bash
# 1. Start the server (after the wLLM install in ../USAGE.md)
...
in an external router (e.g., several wLLM instances behind a
load balancer).
