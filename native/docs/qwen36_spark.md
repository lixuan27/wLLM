...
This document covers the wLLM Spark path for Qwen3.6-27B NVFP4 on
...
os.environ["WLLM_QWEN36_MTP_CKPT_DIR"] = "/models/Qwen3.6-27B-FP8-MTP"
...
export WLLM_QWEN36_MTP_CKPT_DIR=/models/Qwen3.6-27B-FP8-MTP
...
override `WLLM_QWEN36_TQ_SPEC_K`,
`WLLM_QWEN36_LONG_MTP_PREFILL_TAIL`, or FP8-XQA env vars for
experiments.
