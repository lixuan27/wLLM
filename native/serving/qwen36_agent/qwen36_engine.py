...
class Qwen36FrontendAgentEngine:
    ...
    def spec_enabled(self) -> bool:
        ...
        slower non-spec fallback — set WLLM_QWEN36_MTP_CKPT_DIR to enable."""
    ...
    def _set_agent_runtime_env_defaults(capability) -> None:
        ...
        if cap_major >= 12:
            if (cap_major, cap_minor) == (12, 0):
                os.environ.setdefault("WLLM_QWEN36_DECODE_FASTGEMM", "1")
                os.environ.setdefault("WLLM_QWEN36_VERIFY_WARPSPLIT", "1")
            os.environ.setdefault("WLLM_QWEN36_TQ_VERIFY_GRAPH", "0")
            os.environ.setdefault("WLLM_QWEN36_TQ_MTP_CHAIN_GRAPH", "0")
