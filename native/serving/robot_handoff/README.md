...
A serving host for a **multi-model robot hierarchy** built on the wLLM
...
- A CUDA GPU; the wLLM runtime built with the Pi0.5 path (FP8 frontend), and
  the execution-contract module `_wllm_exec` built
