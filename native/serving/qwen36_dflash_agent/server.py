#!/usr/bin/env python3
"""wLLM — Qwen3.6-27B DFlash OpenAI-compatible serving host.
...
This is the policy layer above the wLLM execution contract: it owns
...
Usage:
    ...
    export WLLM_QWEN36_MTP_CKPT_DIR=/models/Qwen3.6-27B-FP8
    export WLLM_QWEN36_DFLASH_CKPT_DIR=/models/Qwen3.6-27B-DFlash
...
def create_app(args):
    ...
    app = FastAPI(title='wLLM Qwen3.6 DFlash server')
...
def main() -> int:
    ...
    os.environ.setdefault('WLLM_QWEN36_LONG_KV_CACHE', 'fp8')
