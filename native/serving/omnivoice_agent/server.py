...
Uses wllm_native.models.omnivoice for BF16+FP4 hybrid acceleration.
...
def _load(ckpt, cfg_ratio=0.05, bookend=False):
    ...
    from wllm.native.models.omnivoice import inject
...
def _create_app():
    ...
    app = FastAPI(title="OmniVoice wLLM", version="1.0.0")
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(description="OmniVoice wLLM serve")
