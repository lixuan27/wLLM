...
The forward path routes through wLLM's existing FP8 kernel
(``wllm_native.wllm_kernels.GemmRunner.fp8_nn_dev``) and the runtime
...
(``wllm_native/core/weights/transformer.py:quantize_fp8_e4m3``):
...
#
# The vendored kernels (``wllm_native.wllm_kernels``) drive cuBLASLt
