...
[`wllm_native/core/rl/`](../../wllm_native/core/rl/) (ACP tags, advantage,
...
wLLM's PyTorch path is one of several ways to fine-tune pi0.5
...
1. An **XLA FFI handler** that exposes wLLM's cuBLASLt FP8 GEMM
...
[`wllm_native/core/rl/`](../../wllm_native/core/rl/); the JAX path only
...
`openpi-compiler/RL/scripts/train_jax_lora_recap.py`. wLLM
...
[`wllm_native/frontends/jax/pi05_rtx.py`](../../wllm_native/frontends/jax/pi05_rtx.py)
...
[`wllm_native/core/rl/`](../../wllm_native/core/rl/); both stacks import
...
[`wllm_native/core/rl/value_function.py`](../../wllm_native/core/rl/value_function.py).
...
optimizer + dataset pipeline rather than the wLLM PyTorch one.
...
on import — the plugin's clustering pass rejects wLLM's XLA
