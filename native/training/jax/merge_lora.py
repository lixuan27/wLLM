...
inference, including
:class:`wllm_native.frontends.jax.pi05_rtx.Pi05JaxFrontendRtx`.
...
JAX-native end to end. Users running the wLLM torch frontend
...
def _save_orbax_from_flat(
    ...
    *,
    ...
    (the loader path
    :func:`wllm_native.core.weights.loader._load_orbax` uses for
