"""JAX equivalents of the torch-tensor-using helpers in ``wllm_native.core.rl.reward``.

The PyTorch reference is ``wllm_native/core/rl/reward.py``:
...
def compute_soft_value_loss(
    ...
    batch. Mirrors :func:`wllm_native.core.rl.reward.compute_soft_value_loss`.
    """
