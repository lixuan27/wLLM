...
Mirror of :mod:`wllm_native.core.rl.value_function` (PyTorch). Same
...
Wiring matches ``wllm_native.core.rl.value_function`` and
...
class ValueFunctionHead(nnx.Module):
    ...
    Architecture mirrors :class:`wllm_native.core.rl.value_function.ValueFunctionHead`
    1-for-1::
