#ifndef WLLM_MODELS_PI05_CPP_RUNTIME_IO_H
#define WLLM_MODELS_PI05_CPP_RUNTIME_IO_H
 ...
 * wrt_runtime_export_v1, and graph replay. */
class RuntimeIo {
public:
...
#endif  // WLLM_MODELS_PI05_CPP_RUNTIME_IO_H
