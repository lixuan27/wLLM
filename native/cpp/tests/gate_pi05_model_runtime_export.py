...
Run inside the CUDA container from the repo root:
    ...
    python cpp/tests/gate_pi05_model_runtime_export.py \
      ...
      --lib cpp/build-container/libwllm_cpp_pi05_c.so
...
from wllm.native.core.utils.actions import LIBERO_ACTION_DIM, unnormalize_actions  # noqa: E402
from wllm.native.subgraphs.pi05.context_action import enable as enable_context_action  # noqa: E402
from wllm.native.subgraphs.pi05.rtc_prefix import enable as enable_rtc_prefix  # noqa: E402
...
def main() -> None:
    ...
    ap.add_argument("--lib", default=str(
        ROOT / "cpp/build-container/libwllm_cpp_pi05_c.so"))
    args = ap.parse_args()
