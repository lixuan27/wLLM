#!/usr/bin/env python3
"""Report the CUDA/C++ translation units compiled into each wLLM pybind
...
and reflects the *configured* options (e.g. GPU_ARCH, WLLM_* gates), which
...
# Categorization of the wllm_native_kernels flat source list, mirroring the
...
def print_report(report: dict[str, object]) -> None:
    print(f"wLLM build inventory  (build dir: {report['build_dir']})")
    print("=" * 64)
