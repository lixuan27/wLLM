"""Build a wLLM Qwen3-VL checkpoint (NVFP4 LLM + BF16 vision tower).

Qwen ships Qwen3-VL only in BF16 / FP8; the wLLM RTX path expects the
...
def main() -> None:
    ...
    ap.add_argument('--dst', required=True, help='output wLLM ckpt dir')
    args = ap.parse_args()
