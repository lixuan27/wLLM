...
Runs the SAME process logic under WLLM_QWEN36_USE_EXEC=0 vs =1 (one value per
process) and prints:
...
Run twice (inside the CUDA container):
  for v in 0 1; do
    ...
    WLLM_QWEN36_USE_EXEC=$v \
    WLLM_QWEN36_NVFP4_CKPT_DIR=checkpoints/qwen36_nvfp4 \
    WLLM_QWEN36_MTP_CKPT_DIR=checkpoints/qwen36_mtp_inferrouter \
...
USE_EXEC = os.environ.get("WLLM_QWEN36_USE_EXEC", "0")
