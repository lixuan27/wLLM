/* wLLM exec — internal hardware backend interface.
 *
 ...
 * the public wrt_status codes. No exceptions cross this boundary.
 */
#ifndef WLLM_EXEC_BACKEND_H
#define WLLM_EXEC_BACKEND_H
