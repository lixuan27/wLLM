...
from wllm.serving.configs.models.encoders import BaseEncoderOutput, T5Config
from wllm.serving.distributed import get_tp_rank, get_tp_world_size
from wllm.serving.layers.activation import get_act_fn
from wllm.serving.layers.layernorm import RMSNorm
from wllm.serving.layers.linear import (
    MergedColumnParallelLinear,
    QKVParallelLinear,
    RowParallelLinear,
)
from wllm.serving.layers.quantization import QuantizationConfig
from wllm.serving.layers.vocab_parallel_embedding import VocabParallelEmbedding
from wllm.serving.models.encoders.base import TextEncoder
from wllm.serving.loader.weight_utils import default_weight_loader
...
class T5Attention(nn.Module):
    ...
    def forward(
        ...
        if attention_mask is not None:
            ...
            mask_val = torch.finfo(q.dtype).min
