...
from wllm.serving.distributed.device_communicators.base_device_communicator import DeviceCommunicatorBase
from wllm.serving.distributed.utils import StatelessProcessGroup
    ...
    def __init__(
        ...
        if use_device_communicator and self.world_size > 1:
            ...
            if current_platform.is_cuda_alike():
                from wllm.serving.distributed.device_communicators.cuda_communicator import CudaCommunicator
...
def init_distributed_environment(
    ...
    logger.info(
        ...
        distributed_init_method, backend, local_main_process_only=False)
