...
from wllm.serving.distributed.device_communicators.pynccl_wrapper import (
...
from wllm.serving.utils.utils import current_stream
...
class PyNcclCommunicator:
    ...
    def __init__(
        ...
        logger.info("wLLM is using nccl==%s", self.nccl.ncclGetVersion())
