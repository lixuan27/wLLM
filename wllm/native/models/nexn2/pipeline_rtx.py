"""wLLM -- Nex-N2-mini static dims + BF16 reference pipeline.
...
(``wllm_native.frontends.torch._nexn2_rtx_{forward,decode}``), not here.
...
class Nexn2Pipeline:
    ...
    ``wllm_native.frontends.torch._nexn2_rtx_{forward,decode}``.
    """
