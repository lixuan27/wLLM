...
from wllm.native.models.lingbot.kernel_ops import (
...
def prepare_vlm_fp4_weights(target, num_layers: int = 36) -> None:
    ...
    if getattr(target, _VLM_FP4_DONE, False):
        return
    from wllm.native.models.lingbot import fp4_ops
...
def _has_static_scales() -> bool:
    from wllm.native.models.lingbot import calibration as _calib
...
def _kv_cache_dtype() -> torch.dtype:
    ...
    from wllm.native.models.lingbot import mixed_attention as _m
...
from wllm.native.models.lingbot.mixed_attention import (
...
from wllm.native.models.lingbot.kernel_ops import attention_fa4_fused
from wllm.native.models.lingbot.norms import ada_rms_norm, rms_norm
from wllm.native.models.lingbot.rope_adapter import (
