...
(``wllm_native.wllm_fp4``, sm_110a block-scaled NVFP4 GEMM).

Mirrors ``wllm_native/executors/fp4_utils.py`` but binds the module name present in
this build (``wllm_native.wllm_fp4``). FP4 = W4A8-style NVFP4 (e2m1 4-bit
...
try:
    import wllm.native.wllm_fp4 as _fp4
