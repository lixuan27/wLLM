...
from wllm.native.models.lingbot.sample_actions import sample_actions
...
def sample_actions_split_graph(
    *,
    ...
    """
    from wllm.native.models.lingbot.sample_actions import (
        embed_prefix, predict_velocity, make_att_2d_masks, precompute_film,
    )
    from wllm.native.models.lingbot.forward import prefix_encode_36L
    from wllm.native.models.lingbot.mixed_attention import DEFAULT_ATTN_DIMS
