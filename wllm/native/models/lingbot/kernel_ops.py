"""LingBot-VLA kernel wrappers around the shared ``wllm_native_kernels`` symbols.
...
# import is fully isolated in wllm_native.hardware.thor.fa4_backend — it loads the
# trimmed, privately-named `wllm_fa4` vendor (no global `flash_attn`
...
def _get_lingbot_ext():
    ...
    if _LINGBOT_EXT is None:
        from wllm.native.models.lingbot._csrc_loader import get_lingbot_ext
