"""wLLM -- MiniMax-Remover FP8 kernelized inference pipeline.
...
from wllm.native.models.minimax_remover._utils import load_fp8_kernels
from wllm.native.models.minimax_remover._kernels import mask_mul
...
def _import_runtime_fp8():
    ...
    from ._fp8_linear import install_wllm_fp8, set_calibration, freeze_calibration
...
class MiniMaxRemoverPipelineFP8:
    ...
    def __init__(self, pipe, num_inference_steps=12, fp8_target="all",
        ...
        (install_wllm_fp8, set_calibration, freeze_calibration,
        ...
        fp8_target_env = os.environ.get("WLLM_FP8_TARGET", fp8_target)
        n_lin = install_wllm_fp8(self.transformer,
        ...
        from wllm.native.models.minimax_remover._fp8_manual_denoise import (
            FP8ManualDenoise,
        )

        # Manual graph-capturable denoise (used once calibrated + when
        # WLLM_FP8_GRAPH=1). Lazily captures a CUDA Graph per latent shape.
    ...
    def __call__(self, *args, **kwargs):
        ...
        When ``WLLM_FP8_GRAPH=1`` and scales are frozen (call 2+), the
        ...
        """
        use_graph = os.environ.get("WLLM_FP8_GRAPH", "0") == "1"
        ...
        elif os.environ.get("WLLM_FP8_EAGER_MANUAL", "1") == "1":
