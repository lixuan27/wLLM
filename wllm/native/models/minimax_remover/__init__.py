"""wLLM -- MiniMax-Remover video inpainting pipeline.
...
Both pipelines rewrite transformer Linears as quantized GEMMs over wLLM
...
from wllm.native.models.minimax_remover.pipeline import MiniMaxRemoverPipeline
from wllm.native.models.minimax_remover._fp8_pipeline import MiniMaxRemoverPipelineFP8
from wllm.native.models.minimax_remover._utils import load_nvfp4_kernels, load_fp8_kernels
