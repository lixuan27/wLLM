"""wLLM — RTX (consumer discrete GPU) Pi0 inference pipeline.

Framework-agnostic pipeline for Pi0 on consumer RTX GPUs (Blackwell SM120
/ Ada SM89, 5090 / 4090). Mirrors ``wllm_native/models/pi05/pipeline_rtx.py``
...
class Pi0Pipeline:
    ...
    Args:
        ...
        fvk:          The ``wllm_native_kernels`` module.
        ...
        weights:      Pointer dict — see ``_build_pipeline_weights`` in
                      ``wllm_native.frontends.torch.pi0_rtx``.
