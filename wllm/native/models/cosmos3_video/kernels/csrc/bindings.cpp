...
// the production wllm_native_kernels.so (per docs/adding_new_model.md §4.3 it lives
...
PYBIND11_MODULE(cosmos3_video_kernels, m) {
  m.doc() = "Cosmos3-video model-local kernels (additive; not in wllm_native_kernels.so)";
