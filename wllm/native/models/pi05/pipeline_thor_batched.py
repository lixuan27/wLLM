"""wLLM — Pi0.5 Thor SM110 batched (B>=1) inference pipeline.

Companion to :mod:`wllm_native.models.pi05.pipeline_thor` which holds
...
:mod:`wllm_native.models.pi05.pipeline_rtx` and
:mod:`wllm_native.models.pi05.pipeline_rtx_batched`, and the existing
:mod:`wllm_native.models.pi05.pipeline_thor_cfg` /
:mod:`wllm_native.models.pi05.pipeline_thor_cfg_batched` cfg / cfg-
batched split.
...
def decoder_forward_b2(ctx, fvk, bufs, weights, dims, stream=0, *,
    ...
    :func:`wllm_native.hardware.thor.shared_primitives_batched.encoder_forward_b2`:
      ...
      * AdaRMSNorm-style ops (``fused_adarms_fp8_static_fp16``,
        ...
        :class:`wllm_native.models.pi05.pipeline_rtx_batched.Pi05BatchedPipeline`
    ...
    Args:
        bufs: same key set as
            :func:`wllm_native.models.pi05.pipeline_thor.decoder_forward`;
...
class Pi05ThorBatchedPipeline(Pi05ThorPipeline):
    ...
    Args:
        batch_size: Must be ``>= 1``. Stage 3's
            :class:`wllm_native.models.pi05.pipeline_thor_cfg_batched.Pi05ThorCFGBatchedPipeline`
