"""wLLM — Pi0.5 Thor SM110 fused B=2 classifier-free-guidance pipeline.

Single-inheritance subclass of
:class:`wllm_native.models.pi05.pipeline_thor_batched.Pi05ThorBatchedPipeline`
...
(``wllm_native/models/pi05/pipeline_rtx_cfg_batched.py``).
...
:func:`wllm_native.models.pi05.pipeline_thor_batched.decoder_forward_b2` with
...
class Pi05ThorCFGBatchedPipeline(Pi05ThorBatchedPipeline):
    ...
    Mirrors RTX
    :class:`wllm_native.models.pi05.pipeline_rtx_cfg_batched.Pi05CFGBatchedPipeline`:
    slot 0 carries the conditioned prompt, slot 1 carries the
