"""wLLM — Pi0.5 Thor SM110 decoder pipeline (B=1, main-line path).
...
:mod:`wllm_native.models.pi05.pipeline_thor_batched` (mirrors the RTX
``pipeline_rtx`` / ``pipeline_rtx_batched`` split). The CFG variants
live in :mod:`wllm_native.models.pi05.pipeline_thor_cfg` (serial) and
:mod:`wllm_native.models.pi05.pipeline_thor_cfg_batched` (B=2 fused).
