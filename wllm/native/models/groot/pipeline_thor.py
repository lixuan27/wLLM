"""wLLM — GROOT N1.6 Pipeline for Thor SM110.

Composes wllm_native_kernels into full GROOT inference pipeline.
...
class CKernelQwen3:
    ...
    All operations use wllm_native_kernels: rms_norm, FP8 GEMM, RoPE,
