...
Cache location: ~/.wllm/weights/{ckpt_hash}_nv{num_views}.bin
...
WEIGHT_CACHE_DIR = Path.home() / ".wllm" / "weights"
CACHE_VERSION = 1
MAGIC = b"FVW1"  # wLLM Weights v1
...
def save_weight_cache(checkpoint_path: str, num_views: int,
    ...
    """
    from wllm.native.core.quant.calibrator import _checkpoint_hash
