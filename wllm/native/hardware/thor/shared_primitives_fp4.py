...
DOES NOT MODIFY:
    ...
    - wllm_native_kernels.so               (unchanged)
    - any existing kernel source         (unchanged)

Uses:
    - fvk (wllm_native_kernels)  for all FP8 kernels + gate_geglu_merged_fp16
    - fvk_fp4 (wllm_native_fp4)  for NVFP4 GEMM + norm_fp16 + quant/reshape
"""
