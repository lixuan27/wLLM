"""wLLM -- Thor SM110 model-agnostic primitives, B=1 main-line path.
...
:mod:`wllm_native.hardware.thor.shared_primitives_batched`
    ...
    for l in range(L):
        ...
        if not last:
            ...
            if enc_path == "pre_mk1":
                ...
                # (wllm_encoder_ffn_block_fp16).  Default 0 = current
                ...
                if _ffn_bundle:
                    fvk.wllm_encoder_ffn_block_fp16(
                        x, ones, x_norm,
                ...
                _g8 = g8_kernel
                if _g8 == "bundled":
                    fvk.wllm_megakernel_geglu_g8_fp16(
                        x_norm, weights['gate_w'][l], up_w_ptr,
                        weights['down_w'][l],
                        hidden, x,
                        Se, H, D, stream)
                else:
                    fvk.wllm_megakernel_geglu_fp16(
                        x_norm, weights['gate_w'][l], up_w_ptr,
