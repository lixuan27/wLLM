"""wLLM — RTX Qwen3 (plain dense) full-attention backend.
...
Backed by the vendored FlashAttention-2 ``wllm_native_fa2.fwd_bf16``.
...
class RtxFlashAttnBackendQwen3:
    ...
    def __init__(self, max_seq: int, max_q_seq: int = 1, dtype=None,
        ...
        self._fp8_prefill = (
            os.environ.get("WLLM_QWEN3_FP8_ATTN", "0") == "1"
        ...
        # Takes precedence over WLLM_QWEN3_FP8_ATTN when both are set.
        self._fp8_direct = False
        if (os.environ.get("WLLM_QWEN3_FP8_FMHA", "1") == "1"
                and self._max_q_seq >= 128):
            from wllm.native import wllm_native_kernels as _fvk
