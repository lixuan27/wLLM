"""wLLM -- RTX backbone attention backend for GROOT N1.7.
...
wLLM kernels on RTX, so ``set_prompt`` produces ``backbone_features`` from
    ...
    def __init__(
        ...
        *,
        ...
        try:
            ...
            raise RuntimeError(
                "GROOT N1.7 RTX backbone backend requires wLLM's vendored "
                "FA2 module (`wllm_native.wllm_fa2`). Build it with CMake on "
                "RTX targets.")
        self._fa2 = fa2
