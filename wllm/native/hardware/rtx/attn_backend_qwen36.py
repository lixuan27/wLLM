"""wLLM -- RTX Qwen3.6-27B full-attention backend.
...
chunks use wLLM native Gated DeltaNet kernels; full-attention chunks
...
class RtxFlashAttnBackendQwen36:
    ...
    Built atop the vendored FA2 (``wllm_native.wllm_fa2.fwd_bf16``).
