"""wLLM — RTX consumer discrete GPU attention backends.

Hardware-specific attention backends for RTX GPUs (SM80/86/89/120).
Model pipelines live in ``wllm_native.models.*``; frontends live in
...
(:mod:`wllm_native.wllm_fa2`) and are framework-neutral — used
