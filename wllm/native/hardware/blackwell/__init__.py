"""wLLM — Blackwell (SM120+) hardware-specific backend.
...
``wllm_native.hardware.rtx`` — that module targets SM89+ discrete GPUs with
the same kernel + frontend structure as ``wllm_native.hardware.thor``, and
