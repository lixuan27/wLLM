"""wLLM — AttentionBackend protocol.

Anchors the upstream refactor: every model pipeline in ``wllm_native.models.*``
...
in exactly one place (``wllm_native.hardware.{thor,rtx}.attention_*``).
