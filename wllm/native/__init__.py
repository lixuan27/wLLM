"""
wLLM — High-performance VLA inference engine.

Public exports (stable API — see ``docs/stable_api.md``):

    wllm_native.load_model(...)   → VLAModel
    wllm_native.VLAModel          — unified inference wrapper
...
# directories to the secure DLL loader so `import wllm_native` works
...
from wllm.native.api import load_model, VLAModel  # noqa: E402
