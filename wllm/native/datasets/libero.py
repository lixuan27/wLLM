...
* :class:`LiberoDataset` — builds the metadata DataFrame (episode × frame)
  that :func:`wllm_native.core.calibration.stratified_sample_indices` expects,
...
class LiberoDataset:
    ...
    shape required by
    :func:`wllm_native.core.calibration.stratified_sample_indices`.
...
def load_calibration_obs(
    ...
    *,
    ...
    :func:`wllm_native.core.calibration.stratified_sample_indices`. The
