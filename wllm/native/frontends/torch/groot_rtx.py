"""wLLM -- RTX GROOT N1.6 torch frontend.
...
in :mod:`wllm_native.models.groot.pipeline_rtx`.

Usage::

    from wllm.native.hardware.rtx import GrootTorchFrontendRtx
...
def _calibrate_qwen3_per_sample(sd, gemm, fvk, qwen3, ie_fp16_list, stream=0):
    ...
    for ``wllm_native.core.calibration.accumulate_amax`` percentile reduction.
    """
    if not ie_fp16_list:
