"""wLLM — GrootTorchFrontendThor: GROOT N1.6 inference via wllm_native_kernels.so.
...
from wllm.native.hardware.thor.shared_primitives import siglip_forward  # SigLIP2 == Pi0.5 SigLIP
from wllm.native.hardware.thor.attn_backend_groot import (
    ThorGrootAttnBackend,
    make_groot_attention_spec,
)
from wllm.native.models.groot.pipeline_thor import (
    siglip2_forward,
    eagle_project,
    qwen3_forward,
    dit_forward,
...
# wllm_native/hardware/groot_embodiments.py. Same 32-slot per-embodiment
# MLP layout; only a subset of slots have trained weights in the
# GR00T-N1.6-3B base checkpoint (see TRAINED_EMBODIMENT_IDS).
from wllm.native.models.groot.embodiments import (
...
from wllm.native.core.thor_frontend_utils import quant_fp8  # noqa: E402
...
class GrootTorchFrontendThor:
    ...
    def _load_siglip2_weights(self, sd):
        ...
        from wllm.native.executors.torch_weights import DictSource, WeightLoader
        from wllm.native.frontends.torch._groot_thor_spec import build_siglip2_spec
    ...
    def _calibrate_qwen3(self, ie_fp16):
        ...
        try:
            ...
            from wllm.native.core.quant.calibrator import _checkpoint_hash, _cache_path
            import json
    ...
    def _capture_all_graphs(self, obs, release_full_sd: bool = True):
        ...
        """
        from wllm.native.models.groot.pipeline_thor import CKernelQwen3, CKernelDiTHead
