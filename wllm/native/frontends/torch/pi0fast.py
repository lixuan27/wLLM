"""wLLM -- Pi0FastTorchFrontend: Autoregressive Pi0-FAST inference.
...
from wllm.native.core.thor_frontend_utils import (  # noqa: E402
...
class Pi0FastTorchFrontend:
    ...
    def _load_tokenizer(self):
        # Locate via the shared wLLM helper (env var → XDG cache →
