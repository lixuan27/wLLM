"""wLLM -- GROOT N1.7 FP8 torch frontend for RTX (SM120 / SM89).

Framework-conforming FP8 path for GROOT N1.7 on RTX. The whole VLM backbone
(ViT / DeepStack / LLM / VL self-attn) runs through wLLM FP8 kernels via the
SM120-safe descale pattern in :mod:`wllm_native.models.groot_n17.pipeline_rtx_fp8`
...
Activation scales follow the wLLM calibration convention (docs/calibration.md):
weight scales are baked at load; activation scales are calibrated once and
cached to disk (``~/.wllm/calibration/<hash>_n17_Se<N>.json``). On a warm
...
from wllm.native.frontends.torch.groot_n17_rtx import GrootN17TorchFrontendRtx
from wllm.native.frontends.torch.groot_n17_rtx_fp16 import GrootN17TorchFrontendRtxFP16
...
class _GrootN17FP8BackboneMixin:
    ...
    def _load_calibration_cache(self) -> "dict | None":
        import json
        from wllm.native.core.quant.calibrator import _checkpoint_hash, CACHE_DIR
    ...
    def _ensure_act_scales(self, aux: dict) -> None:
        ...
        from wllm.native.models.groot_n17 import calibration as cal
    ...
    def set_prompt(self, *, aux: dict, prompt: str | None = None) -> None:
        from wllm.native.models.groot_n17.calibration import build_vit_rope_tables
    ...
    def _run_kernel_backbone_fp8(self, aux: dict) -> "torch.Tensor":
        ...
        from wllm.native.models.groot_n17 import pipeline_rtx_fp8 as P
        from wllm.native.hardware.rtx.attn_backend_groot_n17_backbone import (
