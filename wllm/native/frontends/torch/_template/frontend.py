"""wLLM new-model template — frontend (entry point).

Copy this file to `wllm_native/frontends/torch/<mymodel>_<hw>.py`. This
is the class that `wllm_native.load_model()` instantiates. It owns:
...
Your reference inference code:                 wLLM frontend mapping:
------------------------------                 -------------------------
...
# from wllm.native.frontends.torch._mymodel_thor_spec import load_weights, NUM_ENCODER_LAYERS, ...
# from wllm.native.models.mymodel.pipeline_thor import (
...
class TemplateTorchFrontendThor:
    ...
    def __init__(self, checkpoint_dir, num_views=2, autotune=3, **kwargs):
        ...
        # TODO: from wllm.native.frontends.torch._mymodel_thor_spec import load_weights
        ...
        # TODO: from wllm.native.hardware.thor.attn_backend import (
        #     ThorFlashAttnBackend, make_mymodel_attention_spec,
        # )
    ...
    def set_prompt(self, prompt_text, state=None):
        ...
        # PaliGemma's SentencePiece tokenizer; wLLM ships a helper:
        # from wllm.native.core.thor_frontend_utils import embed_prompt_torch
    ...
    def _capture_enc_ae_graph(self):
        ...
        with torch.cuda.stream(s):
            ...
            from wllm.native.models.mymodel.pipeline_thor import encoder_forward, decoder_forward
    ...
    def infer(self, observation):
        ...
        # from wllm.native.core.utils.actions import unnormalize_actions
...
# - [ ] Calibration cache file appears under ~/.wllm/calibration/
