"""wLLM new-model template — weight specification.

Copy this file to `wllm_native/frontends/torch/_<mymodel>_<hw>_spec.py`
...
Your source model:                       wLLM WEIGHT_SPEC entry:
---------------------                    -------------------------------
...
from wllm.native.executors.fp8_utils import quant_weight_fp8
