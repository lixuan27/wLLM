"""wLLM -- Pi0TorchFrontendThor: Pi0 inference using ONLY wllm_native_kernels.so.
...
class Pi0TorchFrontendThor:
    """Complete Pi0 inference pipeline using only wllm_native_kernels.so.
    ...
    def __init__(self, checkpoint_dir: str, num_views: int = 2,
        ...
        # ---- Load CUTLASS FMHA ----
        # Search order: ckpt-adjacent, ``wllm_native/`` package dir (pip
    ...
    def _load_weights(self, safetensors_path):
        ...
        from wllm.native.frontends.torch._pi0_thor_spec import build_spec
