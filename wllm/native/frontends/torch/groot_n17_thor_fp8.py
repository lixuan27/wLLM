"""wLLM -- GROOT N1.7 Thor FP8 frontend (conforming serving path).
...
wLLM convention used by every other model:
...
class GrootN17TorchFrontendThorFP8(GrootN17TorchFrontendThor):
    ...
    def _run_kernel_backbone(self, aux: dict) -> "torch.Tensor":
        ...
        from wllm.native.models.groot_n17 import pipeline_thor as P
