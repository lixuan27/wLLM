"""wLLM -- Nex-N2-mini (qwen3_5_moe) M=1 decode forward.
...
from wllm.native.hardware.rtx.attn_backend_nexn2 import RtxFlashAttnBackendNexn2
...
class Nexn2DecodeState:
    ...
    def __init__(self, handles, max_seq, device):
        ...
        self.graph_cache_max = int(
            os.environ.get('WLLM_NEXN2_GRAPH_CACHE_MAX', '256'))
        ...
        self.prefill_chunk = int(
            os.environ.get('WLLM_NEXN2_PREFILL_CHUNK', '8192'))
