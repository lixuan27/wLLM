"""wLLM -- RTX Pi0 torch frontend.

Mirrors :mod:`wllm_native.frontends.torch.pi05_rtx` but targets Pi0 (not
...
from wllm.native.models.pi0.pipeline_rtx import (
    Pi0Pipeline,
...
def _embed_prompt(prompt_text,
    ...
    if isinstance(prompt_text, (np.ndarray, list)):
        ...
        # `wllm_native.utils.paligemma_tokenizer` for the search order
