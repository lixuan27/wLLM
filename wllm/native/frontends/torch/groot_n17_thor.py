...
class GrootN17TorchFrontendThor:
    ...
    def __init__(
        ...
        *,
        ...
        from wllm.native.models.groot_n17.embodiments import (
    ...
    def _save_calibration_cache(self, out_vit, out_ds, out_llm, out_vlsa) -> None:
        ...
        — different stages). Stored at ``~/.cache/wllm_native/<ckpt_hash>_n17_Se<n>.json``.
        """
        import json
    ...
    def _build_dit_attn(self, Sa: int) -> None:
        ...
        from wllm.native.hardware.thor.attn_backend_groot_n17 import (
