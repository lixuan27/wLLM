"""wLLM -- GROOT N1.7 full-FP16 torch frontend for RTX.
...
proj, decoder) through wLLM kernels; the production path runs those in
...
class GrootN17TorchFrontendRtxFP16(GrootN17TorchFrontendRtx):
    ...
    def _load_weights(self) -> None:
        from wllm.native.executors.torch_weights import MultiSafetensorsSource
        from wllm.native.executors.weight_loader import WeightLoader
        from wllm.native.frontends.torch._groot_n17_thor_spec import WEIGHT_SPEC
    ...
    def _run_dit(self, bufs: dict, shift_list, scale_list, Sa: int) -> None:
        from wllm.native.models.groot_n17 import pipeline_rtx_fp16
    ...
    def _run_kernel_backbone(self, aux: dict) -> "torch.Tensor":
        ...
        feature path — the entire VLM backbone runs through wLLM kernels.
        """
        import wllm.native.wllm_kernels as fvk
        from wllm.native.models.groot_n17 import pipeline_rtx_fp16 as P
