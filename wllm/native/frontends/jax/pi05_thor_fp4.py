"""wLLM — Thor JAX Pi0.5 frontend with NVFP4 encoder-FFN subset.
...
Mirrors :class:`wllm_native.frontends.torch.pi05_thor_fp4.Pi05TorchFrontendThorFP4`
...
from wllm.native.frontends.jax.pi05_thor import Pi05JaxFrontendThor
from wllm.native.executors.fp4_utils_cb import (
    FP4ActScratchCB,
    FP4BufferCB,
    _PtrShim,
    pick_variant,
...
try:
    import wllm.native.wllm_fp4 as fvk_fp4
...
class Pi05JaxFrontendThorFP4(Pi05JaxFrontendThor):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self._fp4_layers:
            if not _HAS_FP4:
                raise RuntimeError(
                    "use_fp4_encoder_ffn=True but wllm_native_fp4 is not "
    ...
    def _capture_enc_ae_graph(self) -> None:
        ...
        from wllm.native.hardware.thor.shared_primitives_fp4 import (
            encoder_forward_with_fp4_subset,
        )
        from wllm.native.models.pi05.pipeline_thor import decoder_forward
    ...
    def _calibrate_multi_frame(self, obs_list, *,
        ...
        """
        from wllm.native.core.cuda_buffer import CudaBuffer
        from wllm.native.core.calibration import accumulate_amax, check_scale_ceiling
        from wllm.native.hardware.thor.shared_primitives import encoder_forward_calibrate
        from wllm.native.models.pi05.pipeline_thor import decoder_forward_calibrate
