...
from wllm.native.frontends.torch.pi05_rtx import (
    CHUNK_SIZE,
...
def convert_pi05_orbax(
    ...
    frontends. See
    ``wllm_native.frontends.torch.pi05_rtx.convert_pi05_safetensors`` for
    the full schema.
    """
    from wllm.native.core.weights.loader import _load_orbax
...
class Pi05JaxFrontendRtx(Pi05TorchFrontendRtx):
    ...
    def __init__(
        ...
        from wllm.native.frontends.torch.pi05_rtx import _precompute_decoder_styles
