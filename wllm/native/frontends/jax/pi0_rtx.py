...
Design mirrors :mod:`wllm_native.frontends.jax.pi05_rtx` — a **thin shim**
...
from wllm.native.frontends.torch.pi0_rtx import (
    CHUNK_SIZE_DEFAULT,
...
class Pi0JaxFrontendRtx(Pi0TorchFrontendRtx):
    ...
    def __init__(
        ...
        from wllm.native.frontends.torch.pi0_rtx import _precompute_time_proj_all
