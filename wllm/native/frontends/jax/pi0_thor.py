"""wLLM — Thor JAX frontend for Pi0 (SM110).

Loads JAX Orbax checkpoints → FP8 quantize (ml_dtypes) → CudaBuffer (cudaMalloc)
→ pipeline_pi0.py (wllm_native_kernels.so) on Jetson AGX Thor.
...
from wllm.native.models.pi0.pipeline_thor import (
    decoder_forward_pi0,
...
class Pi0JaxFrontendThor:
    """Thor SM110 — JAX (Orbax) frontend for Pi0. CudaBuffer bridge to wllm_native_kernels."""
    ...
    def __init__(self, checkpoint_dir, engine_path=None, fmha_path=None,
        ...
        if not cache_hit:
            ...
            from wllm.native.core.weights.transformer import transform_jax_weights_pi0
    ...
    def _upload_weights(self, engine_w, quantize_fp8, compute_time_embeddings):
        ...
        from wllm.native.frontends.jax._pi0_thor_spec import build_spec
    ...
    def _calibrate_multi_frame(
        ...
        the sample axis via :func:`wllm_native.core.calibration.accumulate_amax`,
