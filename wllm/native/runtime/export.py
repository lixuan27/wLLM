"""RuntimeExport — package a captured wLLM model as ``frt_runtime_export_v1``.

The phase-1 PRODUCER of the runtime-export ABI (runtime/include/wllm/runtime.h):
...
def _import_native():
    try:
        import _wllm_runtime as _c  # noqa: F401
        return _c
    except ImportError:
        pass
    ...
    try:
        ...
        raise ImportError(
            "Could not import _wllm_runtime. Build it first:\n"
            "  cmake -S runtime -B runtime/build -DCMAKE_BUILD_TYPE=Release\n"
            "  cmake --build runtime/build -j"
        ) from e
...
@dataclass
class PortSpec:
    """One dynamic input/output of the tick (see wllm/model_runtime.h).
...
def build_metadata_model_runtime(
    *,
    ...
    """Build a provider-owned runtime with no wLLM graph resources.
