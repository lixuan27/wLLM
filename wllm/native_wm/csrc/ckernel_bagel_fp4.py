...
from wllm.native.executors.fp4_utils import FP4ActScratch
    ...
    def forward(self, s=0):
        ...
        for i in range(L):
            ...
            if is_fp4:
                ...
                # Use wllm_native_wm's TRUE-SiLU variant (upstream's kernel is
                ...
                fwk.bagel_silu_mul_fp4_sfa_v2_fp16(
                    ...
                    Sq, FFN, s)
                # 9. FP4 down GEMM → BF16 directly (wllm_native_wm cutlass_fp4_gemm_bf16out).
