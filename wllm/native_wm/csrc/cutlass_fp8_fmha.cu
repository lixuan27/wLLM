...
//
//  Reuses wllm_native's mainloop collective (which has kPRescale precision
...
//    - wllm_native/csrc/attention/collective/ (mainloop_tma_warpspecialized.hpp
...
// CMake include order: wllm_native/csrc/attention/ FIRST, then CUTLASS
// example77. This guarantees wllm_native's modified mainloop (kPRescale FP8
...
#include "collective/sm100_fmha_fwd_mainloop_tma_warpspecialized.hpp"   // wllm_native version
