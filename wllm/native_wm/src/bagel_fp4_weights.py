...
NVFP4 packed + CUTLASS tile-interleaved SFB via wllm_native.wllm_fp4.
...
from wllm.native.executors.fp4_utils import quant_weight_nvfp4
...
def prepare_gen_fp4_weights(weights_root: str,
    ...
    Returns:
        ...
        (as returned by wllm_native.executors.fp4_utils.quant_weight_nvfp4).
    """
